...
class Env:
    def __init__(self):
        ...
        self.reward[3][4] = 1   # (3,4) 좌표 동그라미 위치에 보상 1
        self.reward[0][4] = -1  # (0,4) 좌표 세모 위치에 보상 -1
        self.reward[1][2] = -1  # (1,2) 좌표 세모 위치에 보상 -1
        self.reward[2][4] = -1  # (2,4) 좌표 세모 위치에 보상 -1
        self.reward[3][3] = -1  # (3,3) 좌표 세모 위치에 보상 -1
        self.reward[3][5] = -1  # (3,5) 좌표 세모 위치에 보상 -1
        self.reward[4][2] = -1  # (4,2) 좌표 세모 위치에 보상 -1
        self.reward[5][3] = -1  # (5,3) 좌표 세모 위치에 보상 -1
        self.all_state = []
